...
public interface FundingRepository extends JpaRepository<Funding, Long> {
	@Query("select o from Funding o" + " left join fetch o.payment p" + " left join fetch o.member m"
			+ " where o.fundingUid = :fundingUid")
	Optional<Funding> findFundingAndPaymentAndMember(@Param("fundingUid") String fundingUid);

	@Query("select o from Funding o" + " left join fetch o.payment p" + " where o.fundingUid = :fundingUid")
